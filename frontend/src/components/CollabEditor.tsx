...
CollaborationCursor.configure({
  ...
  return (
    <div className="w-full space-y-6">
            ...
            <div className="flex items-center gap-1">
              ...
              <div className="flex items-center gap-0.5 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-1.5 shadow-inner">
                <button
                  ...
                  title="Heading 1"
                >
                  <span className="transition-transform group-hover:scale-110">H1</span>
                </button>
                ...
                <button
                  ...
                  title="Heading 2"
                >
                  <span className="transition-transform group-hover:scale-110">H2</span>
                </button>
                ...
                <button
                  ...
                  title="Heading 3"
                >
                  <span className="transition-transform group-hover:scale-110">H3</span>
                </button>
              </div>
      ...
      <div className="max-w-4xl mx-auto pt-16"> {/* Added top padding for floating toolbar */}
